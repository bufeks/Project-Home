...
<p class="lead" style="margin:0 0 10px">🏠 <b>1階を貸して住居費を下げる</b>という買い方を検討するなら → <a href="./hybrid.html">一階賃貸スクリーナー（賃貸併用の成立性・実質住居費）</a>／考え方は <a href="./rental_hybrid.md">rental_hybrid.md</a></p>
