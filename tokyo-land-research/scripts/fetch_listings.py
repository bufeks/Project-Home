...
<p class="lead" style="margin:0 0 10px">🏠 <b>1階を貸して住居費を下げる／ローンを早く返す</b>という買い方を検討するなら → <a href="./hybrid.html">一階賃貸スクリーナー</a>・<a href="./loan_plan.html">取得力と返済加速</a>／考え方は <a href="./rental_hybrid.md">rental_hybrid.md</a></p>
